...
MAPA = """<div class="mapa">
  <div class="mapa__stage" id="mapaStage">
    ...
    <svg class="mapa__svg" id="scmap" viewBox="0 0 1000 640" role="img"
      ...
      <!-- alfinetes ficam DENTRO da câmera: a posição vem do mesmo transform
           do mapa, então não existe como sair do lugar. Só a escala de cada
           alfinete é compensada, para o tamanho na tela ficar constante. -->
      <g id="cam">
